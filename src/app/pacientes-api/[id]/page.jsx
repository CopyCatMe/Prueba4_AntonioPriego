...
export default async function PacientesPage({ params }) {
    ...
    return (
        <section className="min-h-screen max-w-[1024px] mx-auto px-10 py-10">
            <Link href="/pacientes-api" className="fixed p-2 bg-orange-300 rounded-full mr-3"> &lt;- Volver </Link>
            ...
            <div className="flex flex-col items-center mt-8 p-6 bg-gray-700 rounded-lg shadow-md">
                ...
                <p className="text-2xl text-white mt-2">{new Intl.DateTimeFormat('es-ES').format(new Date(paciente.fecha_nacimiento))}</p>
            </div>
        </section>
    );
}
